...
class m200000_000000_change_table_fruits extends \yii\db\Migration
{
    ...
    public function down()
    {
        ...
        $this->alterColumn('{{%fruits}}', 'ts6', $this->timestamp()->null()->defaultExpression("CURRENT_TIMESTAMP"));
        $this->alterColumn('{{%fruits}}', 'ts5', $this->timestamp()->null()->defaultValue('2011-11-11 00:00:00'));
        $this->alterColumn('{{%fruits}}', 'ts4', $this->timestamp()->null()->defaultExpression("CURRENT_TIMESTAMP"));
        $this->alterColumn('{{%fruits}}', 'ts3', $this->datetime()->null()->defaultExpression("CURRENT_TIMESTAMP"));
        $this->alterColumn('{{%fruits}}', 'ts2', $this->datetime()->null()->defaultExpression("CURRENT_TIMESTAMP"));
        $this->alterColumn('{{%fruits}}', 'ts', $this->datetime()->null()->defaultValue('2011-11-11 00:00:00'));
    }
}
